...
import { FaArrowLeft, FaCalendarAlt, FaUser, FaMoneyBillWave, FaSpinner, FaNotesMedical } from "react-icons/fa";
...
const AppointmentDetails = () => {
    ...
    return (
      <div className="p-8">
        ...
        <button
          ...
          className="mt-4 flex items-center space-x-2 text-teal-600 hover:text-teal-700"
        >
          <FaArrowLeft />
  ...
  return (
    <div className="p-8">
      <button
        onClick={() => navigate("/doctor/appointments")}
        className="flex items-center space-x-2 text-teal-600 hover:text-teal-700 mb-6 font-semibold"
      >
        <FaArrowLeft />
        <span>Back to Appointments</span>
      </button>
      ...
      <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
        <div className="bg-gradient-to-r from-teal-500 to-cyan-500 p-6 text-white">
          ...
          <p className="text-teal-100">ID: #{appointment.id}</p>
        </div>
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="flex items-start space-x-4 pb-6 border-b">
            <FaCalendarAlt className="text-2xl text-teal-600 mt-1" />
          ...
          {/* Patient Info */}
          <div className="flex items-start space-x-4 pb-6 border-b">
            <FaUser className="text-2xl text-teal-600 mt-1" />
            <div className="flex-1">
          ...
          {appointment.type && (
            <div className="flex items-start space-x-4 pb-6 border-b">
              <FaNotesMedical className="text-2xl text-teal-600 mt-1" />
              <div className="flex-1">
          ...
          {appointment.payment && (
            <div className="flex items-start space-x-4 pb-6 border-b">
              <FaMoneyBillWave className="text-2xl text-teal-600 mt-1" />
              <div className="flex-1">
